...
@Component({
  selector: 'app-no-side-menu-layout',
  templateUrl: './no-side-menu.component.html',
  styleUrls: ['./no-side-menu.component.scss'],
  animations: [slideFadeinUp, slideFadeinRight, zoomFadein, fadein],
})
export class NoSideMenuComponent implements OnInit {
